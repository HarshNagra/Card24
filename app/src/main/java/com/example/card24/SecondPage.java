...
public class SecondPage extends AppCompatActivity {
        ...
        checkInput.setOnClickListener(new Button.OnClickListener() { public void onClick(View view) {
            if(backCount==4) {
                ...
                if (checkInput(inputStr)) {
                    Toast.makeText(SecondPage.this, "Correct Answer", Toast.LENGTH_SHORT).show();
                    pickCard();
                } else {
                    Toast.makeText(SecondPage.this, "Wrong Answer", Toast.LENGTH_SHORT).show();
                    setClear();
                }
            }
            else{
                Toast.makeText(SecondPage.this, "Select All Cards", Toast.LENGTH_SHORT).show();
            }
        }
        });
    ...
    private boolean checkInput(String input) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(SecondPage.this, "Wrong Expression", Toast.LENGTH_SHORT).show();
            return false;
